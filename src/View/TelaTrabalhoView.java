...
public class TelaTrabalhoView implements Observer {
    private Model model;
    private Stage stage;
    ...
    public void iniciarTela(Model model, Stage stage) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("TelaTrabalho.fxml"));
        Parent root = loader.load();

        TelaTrabalhoController controller = loader.getController();
